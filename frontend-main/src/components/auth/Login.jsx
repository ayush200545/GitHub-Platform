...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.warn("Backend login failed. Attempting mock login for UI demonstration...", err);
      // MOCK LOGIN BYPASS IF BACKEND IS DOWN (e.g. no MongoDB)
    ...
    <div className="auth-page-wrapper mesh-bg">
      <div className="auth-form-container">
        ...
        <div className="auth-panel">
          <h2 className="auth-title">Log In to GitForage™</h2>
          ...
          <form onSubmit={handleLogin} className="auth-form">
            ...
            <div className="form-options">
              ...
              <Link to="#" className="forgot-link">Forgotten?</Link>
            </div>
